...
public class ManualTestSymbol {
    ...
    public static void main(String[] args) {
        ...
        // Tester que 2 SymbolTables différentes ne partagent pas les mêmes Symbol --
        SymbolTable t2 = new SymbolTable();
        Symbol s4 = t2.create("foo");
        assertTrue(s1 != s4, "Deux SymbolTables différentes partagent le même Symbol");
        System.out.println("Test for different SymbolTables passed successfully.");
    }
}
