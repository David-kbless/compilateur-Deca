...
public interface DecaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecaParser#initialization}.
	 * @param ctx the parse tree
	 */
	void enterInitialization(DecaParser.InitializationContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecaParser#initialization}.
	 * @param ctx the parse tree
	 */
	void exitInitialization(DecaParser.InitializationContext ctx);
	/**
